CREATE OR REPLACE PROCEDURE generate_random_trip_times(
    demand_dataset integer,
    trip_time_set integer,
    time_resolution real,
    start_time date DEFAULT NULL::date,
    end_time date DEFAULT NULL::date
)
LANGUAGE plpgsql
AS
$$
