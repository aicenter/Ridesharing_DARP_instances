...
from DARP_instances.instance import Request, DARPInstance, Vehicle, Action, ActionType
from DARP_instances.solution import Solution
from DARP_instances.vehicle_plan import VehiclePlan
...
class CordeauNode(DARP_instances.instance.Coordinate):
...
def load(filepath: str) -> DARPInstance:
	...
	with open(filepath, "r", encoding="utf-8") as infile:
		...
		for index in range(num_vehicles):
			vehicles.append(DARP_instances.instance.Vehicle(index, depot_node, vehicle_capacity))
